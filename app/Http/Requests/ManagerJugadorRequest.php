...
class ManagerJugadorRequest extends FormRequest
{
        ...
        switch($this->method())
        {
            ...
            case 'POST':
            {
                return [
                    ...
                    'altura' => 'required|integer|between:1,100',
                    'alturaL' => 'required|integer|between:1,2',
            ...
            case 'PATCH':
            {
                return [
                    ...
                    'pais_id'=>'required|not_in:0',
                    'provincia_id'=> 'required_if:pais_id,1',
                    'altura' => 'required|numeric|size:2',
